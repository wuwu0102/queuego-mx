  ...
  List<String> _privacyBullets(Locale locale) {
    if (locale.languageCode == 'en') {
      return const [
        ...
        'QueueGo MX does not request official documents, bank passwords, sensitive financial data, or sensitive medical information.',
    ...
    return const [
      ...
      'QueueGo MX no solicita documentos oficiales, contraseñas bancarias, datos financieros sensibles ni información médica sensible.',
